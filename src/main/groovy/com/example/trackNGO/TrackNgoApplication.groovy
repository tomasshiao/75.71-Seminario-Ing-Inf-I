...
class TrackNgoApplication {
    ...
    CommandLineRunner initData(CollaboratorRepository collaboratorRepository,
        ...
        (arg) -> {
            ...
            donation1.setPersonDonation(personDonationSet4)
            ...
            Transaction transaction3 = new Transaction(351.24 as BigDecimal, TransactionType.RECEIPT, 3)
            Transaction transaction4 = new Transaction(33212.55 as BigDecimal, TransactionType.SALE, 4)
            Transaction transaction5 = new Transaction(331.91 as BigDecimal, TransactionType.PAYMENT, 5)
...
class WebSecurityConfig{
    ...
    SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http.authorizeRequests()
            ...
            .antMatchers("/api/organization/**", "/api/donation/**", "/api/event/**", "/api/person/**", "/api/transaction/**", "/api/collaborator/organization", "/api/collaborators/names", "/api/collaborators/*/create", "/api/friends/*/create", "/api/donations/*/create", "/api/events/*/create", "/api/transactions/*/create", "/api/donations/*/*/cancel").hasAnyAuthority('ADMIN', 'USER')
